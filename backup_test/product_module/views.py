...
from utils.http_service import get_clint_ip
from .models import Product, ProductCategory, ProductBrand, ProductVisit, ProductGallery


# short key for delete object estefade nashode <Ctrl+Alt+O>
...
class ProductDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['banners'] = SiteBanner.objects.filter(is_active=True,
                                                       position__iexact=SiteBanner.SiteBannerPositions.product_ditail)

        user_ip = get_clint_ip(self.request)
        user_id = None
